...
Класс плагина должен наследоваться от класса [`WebProcessor`](../../../src/sobiraka/processing/web/web.py). Плагин имеет почти неограниченные возможности в рамках обработки отдельной страницы, см. [](../reference/processor-api.md).
