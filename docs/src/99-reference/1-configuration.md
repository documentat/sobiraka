...
Политика выбора заголовков в конечном документе (H1, H2 и так далее).
...
- `global`
   ...
   Заголовок `#` на корневой странице удаляется из конечного документа. Заголовками H1 становятся заголовки `##` с корневой страницы, а также заголовки `#` со страниц одним уровне ниже. 
