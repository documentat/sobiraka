...
Помимо самой темы, в директории также может находиться файл `extension.py`. Если он существует и если в нём определён класс, расширяющий класс `WebProcessor`, то Собирака может использовать его в качестве обработчика по умолчанию, если [`web.processor`](#volume.web.processor) не задан.
...
### `web.processor` {#volume.web.processor}

Путь к файлу Python, в котором определён [обработчик страниц](4-processor-api.md) для тома.

Если настройка не задана, используется обработчик из темы (см. [`web.theme`](#volume.web.theme)) или стандартный класс `WebProcessor`.

### `web.custom_scripts` {#volume.web.custom_scripts}

Список путей к скриптам JS, используемым в оформлении документации.

### `web.custom_styles` {#volume.web.custom_styles}
...
Помимо самой темы, в директории также может находиться файл `extension.py`. Если он существует и если в нём определён класс, расширяющий класс `WeasyPrintProcessor`, то Собирака может использовать его в качестве обработчика по умолчанию, если [`pdf.processor`](#volume.pdf.processor) не задан.

### `pdf.processor` {#volume.pdf.processor}

Путь к файлу Python, в котором определён [обработчик страниц](4-processor-api.md) для тома.

Если настройка не задана, используется обработчик из темы (см. [`pdf.theme`](#volume.pdf.theme)) или стандартный класс `WeasyPrintProcessor`.

### `pdf.custom_styles` {#volume.pdf.custom_styles}
...
Помимо самой темы, в директории также может находиться файл `extension.py`. Если он существует и если в нём определён класс, расширяющий класс `LatexProcessor`, то Собирака может использовать его в качестве обработчика по умолчанию, если [`latex.processor`](#volume.latex.processor) не задан.

### `latex.processor` {#volume.latex.processor}

Путь к файлу Python, в котором определён [обработчик страниц](4-processor-api.md) для тома.

Если настройка не задана, используется обработчик из темы (см. [`latex.theme`](#volume.latex.theme)) или стандартный класс `LatexProcessor`.
