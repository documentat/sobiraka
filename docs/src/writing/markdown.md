...
::: example
**Пример.** Тема [`sobiraka2025`](../../../src/sobiraka/files/themes/sobiraka2025) поддерживает классы “example”, “note”, “warning” и “danger”. Например, предупреждения в документации можно писать так:
