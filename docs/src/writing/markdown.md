...
По умолчанию текст заголовка будет использован при формировании ссылки на страницу из [оглавления](../organizing/toc.md). На это поведение можно повлиять с помощью свойств [`toc_title`](../organizing/metadata.md#toc_title) и [`title`](../organizing/metadata.md#title).
