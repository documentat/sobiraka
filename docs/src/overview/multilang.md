...
Ссылки на страницы формируются с помощью метода `make_internal_url()` класса [`WebBuilder`](../../../src/sobiraka/processing/web/web.py), который является частью Собираки.
