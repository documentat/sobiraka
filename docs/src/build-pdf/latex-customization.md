...
Класс плагина должен наследоваться от класса [`LatexProcessor`](../../../src/sobiraka/processing/latex/latex.py). Плагин имеет почти неограниченные возможности в рамках обработки отдельной страницы, см. [](../reference/processor-api.md).

::: note
Собирака содержит вспомогательные классы для работы с LaTeX-пакетами `minted` и `tabularray`. Чтобы использовать возможности, предоставляемые этими классами, добавьте их в качестве базовых наравне с [`LatexProcessor`](../../../src/sobiraka/processing/latex/latex.py). Подробнее читайте в исходном коде Собираки.
:::