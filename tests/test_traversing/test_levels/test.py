...
class TestLevels(ProjectDirTestCase):
    def test_ids(self):
        expected_ids = (
            'r',
            'r--part1',
    ...
    def test_levels(self):
        for path, level in (
                ...
                (RelativePath() / 'src' / 'part1' / '0-intro.rst', 2),
                (RelativePath() / 'src' / 'part1' / '1-chapter1.rst', 3),
                (RelativePath() / 'src' / 'part1' / '2-chapter2.rst', 3),
                (RelativePath() / 'src' / 'part1' / '3-chapter3.rst', 3),
                (RelativePath() / 'src' / 'part2' / '0-intro.rst', 2),
                (RelativePath() / 'src' / 'part2' / '1-chapter1.rst', 3),
                (RelativePath() / 'src' / 'part2' / '2-chapter2.rst', 3),
                (RelativePath() / 'src' / 'part2' / '3-chapter3' / '0.rst', 3),
                (RelativePath() / 'src' / 'part2' / '3-chapter3' / '1-paragraph1.rst', 4),
                (RelativePath() / 'src' / 'part2' / '3-chapter3' / '2-paragraph2.rst', 4),
                (RelativePath() / 'src' / 'part2' / '3-chapter3' / '3-paragraph3.rst', 4),
        ):
